...
class Literature extends Book {
    String bookName;
    int bookPrice;
    Literature(String pName, String bCategory,String bName, int bPrice){
...
class Fiction extends Book {
    String bookName;
    int bookPrice;
    Fiction(String pName, String bCategory,String bName, int bPrice){
        super(pName,bCategory);
        this.bookName = bName;
        this.bookPrice = bPrice;
    }
...
class method {
    ...
    void insert() {
        ...
        Fiction book1 = new Fiction(pName, bCategory, bName, bPrice);
        System.out.println("Enter the details first book:");
